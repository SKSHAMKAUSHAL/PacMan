...
public class PacMan extends JPanel implements ActionListener, KeyListener {
    ...
    private Image thunderGhostImage;
    ...
    PacMan() {
        ...
        thunderGhostImage=new ImageIcon(getClass().getResource("./scaredGhost.png")).getImage();
    ...
    public void draw(Graphics g) {
        ...
        if (gameOver) {
            g.drawString("Game Over: " + String.valueOf(score)  +"   High score "+ String.valueOf(highScore) , tileSize/2, tileSize/2);
        }
        else {
